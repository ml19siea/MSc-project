...
while True:
 ...
 #face recognition
                    ...
                    try:
                        ...
                        if best_class_probabilities>0.6:
                            ...
                            for H_i in HumanNames:
                                ...
                                cv2.rectangle(frame, (xmin, ymin-20), (xmax, ymin-2), (0,255,255), -1)
                                cv2.putText(frame, "?", (xmin,ymin-5), cv2.FONT_HERSHEY_COMPLEX_SMALL,.60, (0, 0, 0), thickness=1, lineType=1)
    ...
    cv2.putText(frame, predict, (2, frame.shape[0] - 100), cv2.FONT_HERSHEY_SIMPLEX, 0.45, (0, 255, 255), 2)
    cv2.putText(frame, current_fps, (2, frame.shape[0] - 60), cv2.FONT_HERSHEY_SIMPLEX, 0.45, (0, 165, 255), 2)
    cv2.putText(frame, text, (2, frame.shape[0] - 40), cv2.FONT_HERSHEY_SIMPLEX, 0.50, (0, 0, 255), 2)
