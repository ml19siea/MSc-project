...
parser.add_argument("--image", default='./testing/104.jpg', help="image for prediction")
parser.add_argument("--config", default='./yolo_face/yolov3_custom_test.cfg', help="YOLO config path")
parser.add_argument("--weights", default='./yolo_face/yolov3_custom_final.weights', help="YOLO weights path")
parser.add_argument("--names", default='./yolo_face/classes.names', help="class names path")
